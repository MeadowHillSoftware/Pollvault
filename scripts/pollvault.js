...
oPollvault.matchText = function(oObject, sValue, sType) {
    ...
    } else if (sType === "nwn2prefabareas" || sType === "nwn2prefabplaceables" || sType === "nwn2hakpaksoriginal") {
        aSearchFields = ["Name", "Author", "Description", "NWN2Game", 
            "Forum Thread"];
