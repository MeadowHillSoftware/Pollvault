...
oPollvault.handleSearchButtonClick = function(event) {
    ...
    } else if (sType === "nwn2modulesenglish" || sType === "nwn2modulesinternational") {
    ...
    } else if (sType === "nwn2hakpakscombined" || sType === "nwn2hakpaksmodulespecific") {
        var sCategory = $('#nwn2hakpaksoriginal-category').val();
    } else if (sType === "nwn2links") {
        var sCategory = $('#links-category').val();
    } else {
    ...
    if (sType === "creatures") {
        ...
        var sCategory = $('#nwn2hakpaksoriginal-exclude-category').val();
    } else if (sType === "nwn2links") {
        var sCategory = $('#links-exclude-category').val();
    } else {
    ...
    if (sType === "creatures" || sType === "hakpaks" || sType === "models" || sType === "nwn2hakpakscombined" || sType === "nwn2hakpaksoriginal" || sType === "nwn2models" || sType === "nwn2other" || sType === "nwn2plugins" || sType === "nwn2prefabareas" || sType === "nwn2scripts" || sType === "nwn2tutorials" || sType === "nwn2ui" || sType === "nwn2visualeffects" || sType === "other" || sType === "portraits" || sType === "prefabs" || sType === "scripts" || sType === "sounds" || sType === "textures") {
        var sAward = $('#hakpaks-awards').val();
        if (sAward !== "Doesn't Matter") {
            oResults = oPollvault.searchForAwards(oResults, sAward);
        }
    }
    if (sType === "artwork" || sType === "characters" || sType === "movies" || sType === "nwn2gameworlds" || sType === "nwn2modulesinternational" || sType === "nwn2movies" || sType === "nwn2prefabplaceables" || sType === "nwn2textures" || sType === "nwn2tools") {
    ...
    if (sType === "modules" || sType === "gameworlds" || sType === "nwn2modulesinternational") {
    ...
    if (sType === "modules" || sType === "nwn2modulesenglish" || sType === "nwn2modulesinternational") {
    ...
    if (sType === "nwn2hakpakscombined" || sType === "nwn2hakpaksmodulespecific" || sType === "nwn2hakpaksoriginal" || sType === "nwn2modulesenglish" || sType === "nwn2modulesinternational" || sType === "nwn2plugins" || sType === "nwn2portraits" || sType === "nwn2prefabareas" || sType === "nwn2prefabplaceables" || sType === "nwn2tools" || sType === "nwn2ui" || sType === "nwn2visualeffects") {
    ...
    if (sType === "nwn2modulesenglish" || sType === "nwn2modulesinternational") {
    ...
    if (sType === "nwn2textures") {
        var sFormat = $('#texture-format').val();
        if (sFormat === "") {
            oResults = oPollvault.matchTextInOneField(oResults, "TextureFormat", sFormat);
        }
    }
...
oPollvault.handleType = function(event) {
    ...
    if (sName === "artwork") {
        ...
        oPollvault.populateSearchTable(aIds);
        title = $('<b>Search NWN2 Module Specific Hakpaks</b>');
        ...
        oPollvault.populateSearchTable(aIds);
        title = $('<b>Search NWN2 International Modules</b>');
        ...
        var aIds = ['#nwn2other-category-row', 
            ...
            '#rating-row', '#hakpaks-awards-row', '#button-row'];
        oPollvault.populateSearchTable(aIds);
        title = $('<b>Search NWN2 Other</b>');
    } else if (sName === "nwn2plugins") {
        var aIds = ['#nwn2plugins-category-row', 
            '#nwn2plugins-exclude-category-row', '#votes-row', 
            '#rating-row', '#hakpaks-awards-row', '#nwn2-patch-row', 
            '#button-row'];
        oPollvault.populateSearchTable(aIds);
        title = $('<b>Search NWN2 Plugins</b>');
    } else if (sName === "nwn2portraits") {
        var aIds = ['#nwn2portraits-category-row', 
            '#nwn2portraits-exclude-category-row', '#votes-row', 
            '#rating-row', '#nwn2-patch-row', '#button-row'];
        oPollvault.populateSearchTable(aIds);
        title = $('<b>Search NWN2 Portraits</b>');
        ...
        var aIds = ['#nwn2pwc-category-row', 
            '#nwn2pwc-exclude-category-row', '#votes-row', 
            '#rating-row', '#button-row'];
        oPollvault.populateSearchTable(aIds);
        title = $('<b>Search NWN2 PWC</b>');
        ...
        var aIds = ['#nwn2tutorials-category-row', 
            '#nwn2tutorials-exclude-category-row', '#votes-row', 
            '#rating-row', '#hakpaks-awards-row', '#button-row'];
        oPollvault.populateSearchTable(aIds);
        title = $('<b>Search NWN2 Tutorials</b>');
    } else if (sName === "nwn2ui") {
        var aIds = ['#nwn2ui-category-row', 
            '#nwn2ui-exclude-category-row', '#votes-row', 
            '#rating-row', '#hakpaks-awards-row', '#nwn2-patch-row', 
            '#button-row'];
        oPollvault.populateSearchTable(aIds);
        title = $('<b>Search NWN2 UI</b>');
    } else if (sName === "nwn2userscreenshots") {
        var aIds = ['#nwn2userscreenshots-category-row', 
            '#nwn2userscreenshots-exclude-category-row', '#votes-row', 
            '#rating-row', '#button-row'];
        oPollvault.populateSearchTable(aIds);
...
oPollvault.matchText = function(oObject, sValue, sType) {
    ...
    if (sType === "artwork" || sType === "other" || sType === "portraits" || sType === "sounds") {
        ...
        aSearchFields = ["Description", "Name", "Author", "Abilities", 
            ...
            "Attacks", "Damage", "AC", "Levels", "Initiative", "Race", 
            "Properties", "Forums"];
    ...
    } else if (sType === "nwn2hakpakscombined" || sType === "nwn2hakpaksmodulespecific" || sType === "nwn2hakpaksoriginal" || sType === "nwn2models" || sType === "nwn2prefabareas" || sType === "nwn2prefabplaceables" || sType === "nwn2pwc" || sType === "nwn2textures" || sType === "nwn2tools" || sType === "nwn2visualeffects") {
        ...
        aSearchFields = ["Description", "Name", "Author", "Link", 
            "Update Frequency", "Forum Thread", "NWN2Game"];
    } else if (sType === "nwn2modulesenglish") {
        aSearchFields = ["Name", "Author", "Module Types", "Categories", 
            "Description", "NWN2Game", "Forum Thread"];
    } else if (sType === "nwn2modulesinternational") {
        aSearchFields = ["Name", "Author", "Module Types", "Description", 
            "Categories", "NWN2Game", "Forum Thread"];
    ...
    } else if (sType === "nwn2userscreenshots") {
